...
-->
# Конспекты статей
1. [Thiagarajan JJ at el (2020) Accurate and Robust Feature Importance Estimation under Distribution Shifts](#wii)

## <a name="1"></a> Thiagarajan JJ at el (2020) [Accurate and Robust Feature Importance Estimation under Distribution Shifts](https://arxiv.org/pdf/2009.14454.pdf)
...
## <a name="2"></a> Wojtas M, Chen K (2020) [Feature Importance Ranking for Deep Learning](https://arxiv.org/pdf/2010.08973.pdf)
...
## <a name="3"></a> Gimenez JR, Ghorbani A, Zou J (2019) [Knockoffs for the mass: new feature importance statistics with false discovery guarantees](https://arxiv.org/pdf/1807.06214.pdf)
...
## <a name="4"></a> Lundberg S, Lee S (2017) [A Unified Approach to Interpreting Model Predictions](https://proceedings.neurips.cc/paper/2017/file/8a20a8621978632d76c43dfd28b67767-Paper.pdf)
...
## <a name="wii"></a> Shrikumar A, Greenside P, Kundaje A (2017) [Learning Important Features Through Propagating Activation Differences](https://arxiv.org/pdf/1704.02685.pdf)
...
## <a name="1"></a> Schwab P, Karlen W (2019) [CXPlain: Causal Explanations for Model Interpretation under Uncertainty](https://arxiv.org/pdf/1910.12336.pdf)
...
## <a name="1"></a> Strobl C, Boulesteix A, Zeileis A & Hothorn T (2017) [Bias in random forest variable importance measures](https://link.springer.com/content/pdf/10.1186/1471-2105-8-25.pdf)
...
## <a name="1"></a> Gregorutti B, Michel B, Saint-Pierre P (2015) [Grouped variable importance with random forests and application to multiple functional data analysis](https://arxiv.org/pdf/1411.4170.pdf)
...
## <a name="1"></a> Gregorutti B, Michel B, Saint-Pierre P (2017) [Correlation and variable importance in random forests](https://arxiv.org/pdf/1310.5726.pdf)**
...
## <a name="1"></a> Kononenko I et al (2010) [An efficient explanation of individual classifications using game theory](https://www.jmlr.org/papers/volume11/strumbelj10a/strumbelj10a.pdf)
...
## <a name="1"></a> Datta A, Sen S, Zick Y (2016) [Algorithmic transparency via quantitative input influence: theory and experiments with learning systems](http://www.andrew.cmu.edu/user/danupam/datta-sen-zick-oakland16.pdf) [[code]](https://github.com/hovinh/QII)
...
## <a name="1"></a> Fisher A, Rudin C, Dominici F (2018) [All models are wrong but many are useful: Variable importance for black-box, proprietary, or misspecified prediction models, using model class reliance](https://arxiv.org/pdf/1801.01489.pdf) [[code]](https://github.com/aaronjfisher/mcr-supplement)
